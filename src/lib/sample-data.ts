...
export const SAMPLE_SWITCH_GEARS: SwitchGear[] = [
  { id: 1, name: "SG-MV-01", location: "Area Transformer T2/3", unit: "Tonasa 2/3", status: "Aktif Lototo", pic: "Ahmad Fauzi", requester: "Budi Santoso", activeTime: "2026-06-25 08:30", finishTime: "", notifNo: "NOTIF-2026-001", lototoNo: "LT-2026-001", image: "", images: "[]", description: "Pengamanan switch gear untuk area transformator" },
  { id: 2, name: "SG-MV-02", location: "Area Kiln T4", unit: "Tonasa 4", status: "Maintenance", pic: "Rudi Hermawan", requester: "Citra Dewi", activeTime: "2026-06-24 14:00", finishTime: "", notifNo: "NOTIF-2026-002", lototoNo: "LT-2026-002", image: "", images: "[]", description: "Perbaikan panel kontrol" },
  { id: 3, name: "SG-LV-01", location: "Area Packer T5", unit: "Tonasa 5", status: "Selesai", pic: "Dian Permata", requester: "Eko Prasetyo", activeTime: "2026-06-23 09:15", finishTime: "2026-06-23 16:30", notifNo: "NOTIF-2026-003", lototoNo: "LT-2026-003", image: "", images: "[]", description: "Penggantian komponen rusak" },
  { id: 4, name: "SG-MV-03", location: "Area Crusher", unit: "Tonasa 2/3", status: "Aktif Lototo", pic: "Fajar Nugroho", requester: "Gilang Ramadhan", activeTime: "2026-06-25 10:00", finishTime: "", notifNo: "NOTIF-2026-004", lototoNo: "LT-2026-004", image: "", images: "[]", description: "Lockout tagout untuk perawatan crusher" },
  { id: 5, name: "SG-LV-02", location: "Area Raw Mill", unit: "Tonasa 4", status: "Maintenance", pic: "Hendra Gunawan", requester: "Indra Lesmana", activeTime: "2026-06-24 16:30", finishTime: "", notifNo: "NOTIF-2026-005", lototoNo: "LT-2026-005", image: "", images: "[]", description: "Perbaikan sistem kelistrikan" },
  { id: 6, name: "SG-MV-04", location: "Area Finish Mill", unit: "Tonasa 5", status: "Aktif Lototo", pic: "Joko Susilo", requester: "Kurniawan", activeTime: "2026-06-25 07:45", finishTime: "", notifNo: "NOTIF-2026-006", lototoNo: "LT-2026-006", image: "", images: "[]", description: "Pengamanan area finish mill" },
  { id: 7, name: "SG-LV-03", location: "Area Loading", unit: "SG Lainnya", status: "Selesai", pic: "Lestari", requester: "Mega Sari", activeTime: "2026-06-22 11:00", finishTime: "2026-06-22 15:00", notifNo: "NOTIF-2026-007", lototoNo: "LT-2026-007", image: "", images: "[]", description: "Perawatan rutin" },
  { id: 8, name: "SG-MV-05", location: "Area Coal Mill", unit: "Tonasa 2/3", status: "Maintenance", pic: "Nurhayati", requester: "Omar Dani", activeTime: "2026-06-24 08:00", finishTime: "", notifNo: "NOTIF-2026-008", lototoNo: "LT-2026-008", image: "", images: "[]", description: "Overhaul panel utama" },
];
